class Parrot():
  ...
  def __init__(self, model_tag="prithivida/parrot_paraphraser_on_T5", use_gpu=False):
    ...
    self.tokenizer = AutoTokenizer.from_pretrained(model_tag, local_files_only=True)
    self.model     = AutoModelForSeq2SeqLM.from_pretrained(model_tag, local_files_only=True)
